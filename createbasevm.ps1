...
azure vm quick-create -g SCCDemo -n basevm "eastus" -y Linux -Q canonical:ubuntuserver:14.04.2-LTS:latest -u tdradmin -M id_rsa.pub

$vm = azure vm show SCCDemo basevm --json | Convertfrom-Json
